...
describe('grading — perfect runs', () => {
  const cases: { name: string; order: DrinkOrder; prepared: PreparedDrink }[] = [
    {
      name: 'espresso',
      order: makeOrder({ drink: 'espresso', size: 'small', shots: 1 }),
    ...
    {
      name: 'americano',
      order: makeOrder({ drink: 'americano', size: 'medium', shots: 2 }),
      prepared: makePrepared({
        drink: 'americano',
        vessel: 'americano-mug',
        milk: null,
        waterMl: 250,
    ...
    {
      name: 'cappuccino',
      order: makeOrder({ drink: 'cappuccino', size: 'small', shots: 1 }),
      prepared: makePrepared({
        drink: 'cappuccino',
        vessel: 'cappuccino-cup',
        pulls: [{ grind: 'fine', doseGrams: 18, tampOk: true, seconds: 27 }],
    ...
    {
      name: 'flat-white',
      order: makeOrder({ drink: 'flat-white', size: 'small', shots: 2 }),
      prepared: makePrepared({
        drink: 'flat-white',
        vessel: 'flat-white-cup',
...
describe('grading — every FeedbackId is triggerable', () => {
  const table: { tag: FeedbackId; order?: Partial<DrinkOrder>; prepared?: Partial<PreparedDrink> }[] = [
    ...
    {
      tag: 'STEAM_WAND_NOT_PURGED',
      prepared: {
        milk: { typeUsed: 'whole', tempC: 60, foamCm: 0.8, wandPurged: false, jug: 'large-jug', volumeMl: 300 },
      },
    },
    ...
    { tag: 'DOSE_HIGH', prepared: { pulls: [{ grind: 'fine', doseGrams: 22, tampOk: true, seconds: 27 }] } },
    {
      tag: 'WRONG_SIZE',
      prepared: {
        milk: { typeUsed: 'whole', tempC: 60, foamCm: 0.8, wandPurged: true, jug: 'small-jug', volumeMl: 180 },
      },
    },
    { tag: 'WRONG_SHOT_COUNT', prepared: { pulls: [{ grind: 'fine', doseGrams: 18, tampOk: true, seconds: 27 }] } },
    {
      ...
      prepared: {
        pulls: [
          { grind: 'fine', doseGrams: 18, tampOk: false, seconds: 27 },
          { grind: 'fine', doseGrams: 18, tampOk: true, seconds: 27 },
        ],
      },
    },
    ...
    },
    {
      ...
      prepared: {
        pulls: [
          { grind: 'fine', doseGrams: 18, tampOk: true, seconds: 35 },
          { grind: 'fine', doseGrams: 18, tampOk: true, seconds: 27 },
        ],
      },
    },
